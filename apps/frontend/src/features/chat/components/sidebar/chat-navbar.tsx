            ...
            <div className="flex flex-col gap-1.5">
                {convs && convs.map((c) => {
                    ...
                    return <Link
                        ...
                        className={cn(
                            "grid grid-cols-[auto_1fr] auto-rows-auto items-center gap-3 px-3 py-3 rounded-xl transition-colors duration-200",
                    ...
                    >
                        ...
                        <UserTypingAvater isTyping={isTyping} username={c.username} />
